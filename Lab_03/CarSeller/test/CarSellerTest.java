...
public class CarSellerTest {
    ...
    public void returnCarByBrandAndModelTest() {
        ...
        try {
            carSeller.readCars(file);
        } catch (FileNotFoundException e) {
            throw new RuntimeException(e);
        }
        List<Car> suitableCars = carSeller.findCarByMarcaAModello("Tesla", "Model Y");
    ...
    public void returnCarByBrandModelAndYearTest() {
        ...
        List<Car> suitableCars = carSeller.findCarByMarcaAndModelloAndImmatricolazione("Tesla", "Model Y", 2022);
    ...
    public void returnCarByBrandAModelYearAndPriceTest() {
        ...
        List<Car> suitableCars = carSeller.findCarByMarcaAndModelloAndPrezzo("Tesla", "Model Y", 2022, 1000, 5000);
